...
namespace Services.Concrete
{
    public class AuthenticationManager : IAuthenticationService
    {
        ...
        private ClaimsPrincipal GetPrincipalFromExpiredToken(string token)
        {
            ...
            //doğrulama işleminden kullanıcı bilgilerini almak için principalı kullanacağız
            var principal = tokenHandler.ValidateToken(token, tokenValidationParameters,
                out securityToken);
            //security token elde ediyoruz
            var jwtSecurityToken = securityToken as JwtSecurityToken;//result can be null

            //securitytoken oluştuysa validate işlemi gerçekleşmiş oluyor ve kullanıcı bilgilerini
            //dönebiliyoruz, aksi durumda hata fırlatıyoruz.
